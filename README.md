# VL53L1X library using ROI capabilities
...
It has been modified from the pololu library by adding an interface to easily use ROI functionnalities from the VL53L1X.
